    ...
    <div class="flexslider">
        <ul class="slides">
            <li 
                ...
                data-thumb="<?php echo esc_url(get_theme_mod('leo_slider_image_1')); ?>"
                <?php } else {  ?>
                data-thumb="<?php echo esc_url(get_template_directory_uri()); ?>/images/img1.jpg"
                <?php } ?>
            >
                <?php if ( get_theme_mod('leo_slider_image_1') !='' ) {  ?>
            ...
            <li 
                ...
                data-thumb="<?php echo esc_url(get_theme_mod('leo_slider_image_2')); ?>"
                <?php } else {  ?>
                data-thumb="<?php echo esc_url(get_template_directory_uri()); ?>/images/img2.jpg"
                <?php } ?>
            >
                <?php if ( get_theme_mod('leo_slider_image_2') !='' ) {  ?>
            ...
            <li 
                ...
                data-thumb="<?php echo esc_url(get_theme_mod('leo_slider_image_3')); ?>"
                <?php } else {  ?>
                data-thumb="<?php echo esc_url(get_template_directory_uri()); ?>/images/img3.jpg"
                <?php } ?>
            >
                <?php if ( get_theme_mod('leo_slider_image_3') !='' ) {  ?>
            ...
            <li 
                ...
                data-thumb="<?php echo esc_url(get_theme_mod('leo_slider_image_4')); ?>"
                <?php } else {  ?>
                data-thumb="<?php echo esc_url(get_template_directory_uri()); ?>/images/img4.jpg"
                <?php } ?>
            >
                <?php if ( get_theme_mod('leo_slider_image_4') !='' ) {  ?>
...
<div class="leo-contact-me clearfix">
    <div class="col-xs-10">
        <?php if ( get_theme_mod('leo_contact_heading') !='' ) {  ?><h3><?php echo esc_html(get_theme_mod('leo_contact_heading')); ?></h3>
        <?php } else { echo '<h3>'. __( 'Enjoy my work ? Contact me and get a free quote today ' , 'leo' ) ?></h3>
        <?php  } ?>
        <?php if ( get_theme_mod('leo_contact_description') !='' ) {  ?><p><?php echo esc_html(get_theme_mod('leo_contact_description')); ?></p>
    ...
    <div class="col-xs-2">
        ...
        <?php } else {  ?> <a href="#"><?php echo __('Contact Us', 'leo') ?></a>
        <?php } ?>
    </div>
</div>
<div class="leo-home-wid clearfix">
    <div class="col-xs-3"><?php dynamic_sidebar( 'home-sidebar-1' ); ?></div>
    <div class="col-xs-3"><?php dynamic_sidebar( 'home-sidebar-2' ); ?></div>
    <div class="col-xs-3"><?php dynamic_sidebar( 'home-sidebar-3' ); ?></div>
    <div class="col-xs-3"><?php dynamic_sidebar( 'home-sidebar-4' ); ?></div>
</div>
<div class="leo-portfolio clearfix">
    <div class="leo-port-title">
        <?php if ( get_theme_mod('leo_portfolio_heading') !='' ) {  ?><h3><?php echo esc_html(get_theme_mod('leo_portfolio_heading')); ?></h3>
...
<div class="leo-home-wid-2 clearfix">
    <div class="col-xs-6"><?php dynamic_sidebar( 'home-sidebar-5' ); ?></div>
    <div class="col-xs-6"><?php dynamic_sidebar( 'home-sidebar-6' ); ?></div>
</div>
<?php get_footer(); ?>